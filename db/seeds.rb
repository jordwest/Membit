...
Word.find_or_create_by_expression(:order => "145", :expression => "家族", :reading => "家族[かぞく]", :meaning => "Family", :type1 => "Noun", :type2 => "")
Word.find_or_create_by_expression(:order => "146", :expression => "両親", :reading => "両親[りょうしん]", :meaning => "Parents", :type1 => "Noun", :type2 => "")
Word.find_or_create_by_expression(:order => "147", :expression => "父", :reading => "父[ちち]", :meaning => "Father", :type1 => "Noun", :type2 => "")
Word.find_or_create_by_expression(:order => "148", :expression => "母", :reading => "母[はは]", :meaning => "Mother", :type1 => "Noun", :type2 => "")
Word.find_or_create_by_expression(:order => "149", :expression => "子供", :reading => "子供[こども]", :meaning => "Child, children", :type1 => "Noun", :type2 => "")
Word.find_or_create_by_expression(:order => "150", :expression => "息子", :reading => "息子[むすこ]", :meaning => "Son", :type1 => "Noun", :type2 => "")
Word.find_or_create_by_expression(:order => "151", :expression => "娘", :reading => "娘[むすめ]", :meaning => "Daughter", :type1 => "Noun", :type2 => "")
Word.find_or_create_by_expression(:order => "152", :expression => "兄弟", :reading => "兄弟[きょうだい]", :meaning => "Siblings", :type1 => "Noun", :type2 => "")
Word.find_or_create_by_expression(:order => "153", :expression => "兄", :reading => "兄[あに]", :meaning => "Older brother", :type1 => "Noun", :type2 => "")
Word.find_or_create_by_expression(:order => "154", :expression => "姉", :reading => "姉[あね]", :meaning => "Older sister", :type1 => "Noun", :type2 => "")
Word.find_or_create_by_expression(:order => "155", :expression => "弟", :reading => "弟[おとうと]", :meaning => "Younger brother", :type1 => "Noun", :type2 => "")
Word.find_or_create_by_expression(:order => "156", :expression => "妹", :reading => "妹[いもうと]", :meaning => "Younger sister", :type1 => "Noun", :type2 => "")
Word.find_or_create_by_expression(:order => "157", :expression => "祖父", :reading => "祖父[そふ]", :meaning => "Grandfather", :type1 => "Noun", :type2 => "")
Word.find_or_create_by_expression(:order => "158", :expression => "祖母", :reading => "祖母[そぼ]", :meaning => "Grandmother", :type1 => "Noun", :type2 => "")
Word.find_or_create_by_expression(:order => "159", :expression => "孫", :reading => "孫[まご]", :meaning => "Grandchild", :type1 => "Noun", :type2 => "")
Word.find_or_create_by_expression(:order => "160", :expression => "夫婦", :reading => "夫婦[ふうふ]", :meaning => "Husband and wife", :type1 => "Noun", :type2 => "")
Word.find_or_create_by_expression(:order => "161", :expression => "夫", :reading => "夫[おっと]", :meaning => "Husband", :type1 => "Noun", :type2 => "")
Word.find_or_create_by_expression(:order => "162", :expression => "主人", :reading => "主人[しゅじん]", :meaning => "Husband", :type1 => "Noun", :type2 => "")
Word.find_or_create_by_expression(:order => "163", :expression => "妻", :reading => "妻[つま]", :meaning => "Wife", :type1 => "Noun", :type2 => "")
Word.find_or_create_by_expression(:order => "164", :expression => "家内", :reading => "家内[かない]", :meaning => "Wife", :type1 => "Noun", :type2 => "")
Word.find_or_create_by_expression(:order => "165", :expression => "おじ", :reading => "おじ", :meaning => "Uncle", :type1 => "Noun", :type2 => "")
Word.find_or_create_by_expression(:order => "166", :expression => "おば", :reading => "おば", :meaning => "Aunt", :type1 => "Noun", :type2 => "")
Word.find_or_create_by_expression(:order => "167", :expression => "親戚", :reading => "親戚[しんせき]", :meaning => "Relative", :type1 => "Noun", :type2 => "")
Word.find_or_create_by_expression(:order => "168", :expression => "集める", :reading => "集[あつ]める", :meaning => "To collect", :type1 => "Verb", :type2 => "ru")
Word.find_or_create_by_expression(:order => "169", :expression => "生花", :reading => "生花[せいか]", :meaning => "Flower arranging", :type1 => "Noun", :type2 => "")
Word.find_or_create_by_expression(:order => "170", :expression => "絵", :reading => "絵[え]", :meaning => "Picture", :type1 => "Noun", :type2 => "")
Word.find_or_create_by_expression(:order => "171", :expression => "演奏", :reading => "演奏[えんそう]", :meaning => "To play (a musical instrument)", :type1 => "Verb", :type2 => "suru")
Word.find_or_create_by_expression(:order => "172", :expression => "かく", :reading => "かく", :meaning => "Drawing", :type1 => "Verb", :type2 => "u")
Word.find_or_create_by_expression(:order => "173", :expression => "切手", :reading => "切手[きって]", :meaning => "Stamp", :type1 => "Noun", :type2 => "")
Word.find_or_create_by_expression(:order => "174", :expression => "取る", :reading => "取[と]る", :meaning => "To take (a class)", :type1 => "Verb", :type2 => "u")
Word.find_or_create_by_expression(:order => "175", :expression => "撮る", :reading => "撮[と]る", :meaning => "To take (a photo)", :type1 => "Verb", :type2 => "u")
Word.find_or_create_by_expression(:order => "176", :expression => "料理", :reading => "料理[りょうり]", :meaning => "Cooking", :type1 => "Verb", :type2 => "suru")
Word.find_or_create_by_expression(:order => "177", :expression => "男", :reading => "男[おとこ]", :meaning => "Male", :type1 => "Noun", :type2 => "")
Word.find_or_create_by_expression(:order => "178", :expression => "男の子", :reading => "男の子[おとこのこ]", :meaning => "Boy", :type1 => "Noun", :type2 => "")
Word.find_or_create_by_expression(:order => "179", :expression => "男の人", :reading => "男[おとこ]の 人[ひと]", :meaning => "Man", :type1 => "Noun", :type2 => "")
Word.find_or_create_by_expression(:order => "180", :expression => "女", :reading => "女[おんな]", :meaning => "Female", :type1 => "Noun", :type2 => "")
Word.find_or_create_by_expression(:order => "181", :expression => "女の子", :reading => "女の子[おんなのこ]", :meaning => "Girl", :type1 => "Noun", :type2 => "")
Word.find_or_create_by_expression(:order => "182", :expression => "女の人", :reading => "女[おんな]の 人[ひと]", :meaning => "Woman", :type1 => "Noun", :type2 => "")
Word.find_or_create_by_expression(:order => "183", :expression => "方", :reading => "方[かた]", :meaning => "Person (polite)", :type1 => "Noun", :type2 => "")
Word.find_or_create_by_expression(:order => "184", :expression => "子", :reading => "子[こ]", :meaning => "Child", :type1 => "Noun", :type2 => "")
Word.find_or_create_by_expression(:order => "185", :expression => "人", :reading => "人[ひと]", :meaning => "Person", :type1 => "Noun", :type2 => "")
Word.find_or_create_by_expression(:order => "186", :expression => "みな", :reading => "みな", :meaning => "All, everyone", :type1 => "Noun", :type2 => "")
Word.find_or_create_by_expression(:order => "187", :expression => "みんな", :reading => "みんな", :meaning => "All, everyone", :type1 => "Noun", :type2 => "")
Word.find_or_create_by_expression(:order => "188", :expression => "問題", :reading => "問題[もんだい]", :meaning => "Problem, question", :type1 => "Noun", :type2 => "")
Word.find_or_create_by_expression(:order => "189", :expression => "一緒に", :reading => "一緒[いっしょ]に", :meaning => "Together", :type1 => "Adverb", :type2 => "")
Word.find_or_create_by_expression(:order => "190", :expression => "特に", :reading => "特[とく]に", :meaning => "Especially", :type1 => "Adverb", :type2 => "")
Word.find_or_create_by_expression(:order => "191", :expression => "全く", :reading => "全[まった]く", :meaning => "Totally", :type1 => "Adverb", :type2 => "")
Word.find_or_create_by_expression(:order => "192", :expression => "なる", :reading => "なる", :meaning => "To become, turn into", :type1 => "Verb", :type2 => "u")
Word.find_or_create_by_expression(:order => "193", :expression => "わかる", :reading => "わかる", :meaning => "To understand", :type1 => "Verb", :type2 => "u")
Word.find_or_create_by_expression(:order => "194", :expression => "いつか", :reading => "いつか", :meaning => "Sometime", :type1 => "Grammar", :type2 => "")
Word.find_or_create_by_expression(:order => "195", :expression => "いくつか", :reading => "いくつか", :meaning => "Some, several", :type1 => "Grammar", :type2 => "")
Word.find_or_create_by_expression(:order => "196", :expression => "いつでも", :reading => "いつでも", :meaning => "Anytime", :type1 => "Grammar", :type2 => "")
Word.find_or_create_by_expression(:order => "197", :expression => "いつも", :reading => "いつも", :meaning => "Always", :type1 => "Grammar", :type2 => "")
Word.find_or_create_by_expression(:order => "198", :expression => "全て", :reading => "全[すべ]て", :meaning => "All", :type1 => "Noun", :type2 => "")
Word.find_or_create_by_expression(:order => "199", :expression => "全部", :reading => "全部[ぜんぶ]", :meaning => "All", :type1 => "Noun", :type2 => "")
Word.find_or_create_by_expression(:order => "200", :expression => "だれか", :reading => "だれか", :meaning => "Someone", :type1 => "Grammar", :type2 => "")
Word.find_or_create_by_expression(:order => "201", :expression => "だれでも", :reading => "だれでも", :meaning => "Anyone", :type1 => "Grammar", :type2 => "")
Word.find_or_create_by_expression(:order => "202", :expression => "だれも", :reading => "だれも", :meaning => "Everyone", :type1 => "Grammar", :type2 => "")
Word.find_or_create_by_expression(:order => "203", :expression => "どうか", :reading => "どうか", :meaning => "Somehow", :type1 => "Grammar", :type2 => "")
Word.find_or_create_by_expression(:order => "204", :expression => "どこか", :reading => "どこか", :meaning => "Somewhere", :type1 => "Grammar", :type2 => "")
Word.find_or_create_by_expression(:order => "205", :expression => "どこでも", :reading => "どこでも", :meaning => "Anywhere", :type1 => "Grammar", :type2 => "")
Word.find_or_create_by_expression(:order => "206", :expression => "どこも", :reading => "どこも", :meaning => "Everywhere", :type1 => "Grammar", :type2 => "")
Word.find_or_create_by_expression(:order => "207", :expression => "どちらか", :reading => "どちらか", :meaning => "Either", :type1 => "Grammar", :type2 => "")
Word.find_or_create_by_expression(:order => "208", :expression => "どちらでも", :reading => "どちらでも", :meaning => "Whichever", :type1 => "Grammar", :type2 => "")
Word.find_or_create_by_expression(:order => "209", :expression => "どちらも", :reading => "どちらも", :meaning => "Both/neither", :type1 => "Grammar", :type2 => "")
Word.find_or_create_by_expression(:order => "210", :expression => "どなたか", :reading => "どなたか", :meaning => "Someone (polite)", :type1 => "Grammar", :type2 => "")
Word.find_or_create_by_expression(:order => "211", :expression => "どなたでも", :reading => "どなたでも", :meaning => "Anyone (polite)", :type1 => "Grammar", :type2 => "")
Word.find_or_create_by_expression(:order => "212", :expression => "どなたも", :reading => "どなたも", :meaning => "Everyone (polite)", :type1 => "Grammar", :type2 => "")
Word.find_or_create_by_expression(:order => "213", :expression => "どれか", :reading => "どれか", :meaning => "One of them", :type1 => "Grammar", :type2 => "")
Word.find_or_create_by_expression(:order => "214", :expression => "どれでも", :reading => "どれでも", :meaning => "Any of them", :type1 => "Grammar", :type2 => "")
Word.find_or_create_by_expression(:order => "215", :expression => "どれも", :reading => "どれも", :meaning => "All of them/none of them", :type1 => "Grammar", :type2 => "")
Word.find_or_create_by_expression(:order => "216", :expression => "なぜか", :reading => "なぜか", :meaning => "Somehow, for some reason", :type1 => "Grammar", :type2 => "")
Word.find_or_create_by_expression(:order => "217", :expression => "何か", :reading => "何[なに]か", :meaning => "Something", :type1 => "Grammar", :type2 => "")
Word.find_or_create_by_expression(:order => "218", :expression => "何も", :reading => "何[なに]も", :meaning => "Everything", :type1 => "Grammar", :type2 => "")
Word.find_or_create_by_expression(:order => "219", :expression => "何でも", :reading => "何[なに]でも", :meaning => "Anything", :type1 => "Grammar", :type2 => "")
